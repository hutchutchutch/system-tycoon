/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/worker-configuration.d.ts` (hash: db946de7efd1bb2d9e86398bc746e063)
...
interface __BaseEnv_Env {
	...
	BETTER_AUTH_URL: "https://saas.game";
	EMAIL_FROM: "hutch@yakyak.solutions";
	EMAIL_FROM_NAME: "Service as a Software";
	JWT_SECRET: string;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "DesignSessionDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "BETTER_AUTH_URL" | "EMAIL_FROM" | "EMAIL_FROM_NAME" | "JWT_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "RESEND_API_KEY" | "OPENAI_API_KEY">> {}
}
